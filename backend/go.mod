module github.com/veraison/enact-demo
...
require (
	...
	github.com/veraison/apiclient v0.0.1 // indirect
	github.com/veraison/corim v0.0.0-20220131142553-4211ff85addf // indirect
